...
\TLV
   ...
   `BOGUS_USE($rd $rd_valid $rs1 $rs1_valid $rs2 $rs2_valid $imm_valid $funct3 $funct3_valid $opcode $imm) 
   `BOGUS_USE($is_beq $is_bne $is_blt $is_bge $is_bltu $is_bgeu $is_addi $is_add)
   $rd_en1 = $is_addi || $is_add || $is_blt;
   $rd_en2 = $is_addi || $is_add || $is_blt;
   ...
   $wr_en = ($is_addi || $is_add || $is_blt || $is_bge) && $rd != 0;
